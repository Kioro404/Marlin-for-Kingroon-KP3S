...
*/
#define X_PROBE_OFFSET   30.0f
#define Y_PROBE_OFFSET   -1.0f
#define Z_PROBE_OFFSET -2.605f
...
#define STRING_CONFIG_H_AUTHOR "Kioro404" // Who made the changes.
...
#define PID_K1  0.95f             // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  22.20f
    #define DEFAULT_Ki   1.08f
    #define DEFAULT_Kd 114.00f
  #endif
#else
 ...
 */
  ...
  const float FILAMENT_HEAT_CAPACITY[] = {
    0.0056,  /* PLA 1.75mm */
    0.0036,  /* PETG 1.75mm */
    0.00515, /* ABS 1.75mm */
    0.00522, /* Nylon 1.75mm */
  };
  
  #define FILAMENT_HEAT_CAPACITY_PERMM { FILAMENT_HEAT_CAPACITY[1] }    // 0.0056 J/K/mm for 1.75mm PLA (0.0149 J/K/mm for 2.85mm PLA).
...
#define EXTRUDE_MINTEMP PREHEAT_1_TEMP_HOTEND
...
#define MAX_FEEDRATE_E 100
 
#define DEFAULT_MAX_FEEDRATE          { MAX_FEEDRATE_X, \
                                        MAX_FEEDRATE_Y, \
                                        MAX_FEEDRATE_Z, \
                                        MAX_FEEDRATE_E }
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { (MAX_FEEDRATE_X * 2), \
                                        (MAX_FEEDRATE_Y * 2), \
                                        (MAX_FEEDRATE_Z * 2), \
                                        (MAX_FEEDRATE_E * 2) } // ...or, set your own edit limits
#endif
...
#define MAX_ACCELERATION_X 2000
#define MAX_ACCELERATION_Y 2000
#define MAX_ACCELERATION_Z 100
#define MAX_ACCELERATION_E 1000

#define DEFAULT_MAX_ACCELERATION      { MAX_ACCELERATION_X, \
                                        MAX_ACCELERATION_Y, \
                                        MAX_ACCELERATION_Z, \
                                        MAX_ACCELERATION_E }
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { (MAX_ACCELERATION_X * 2), \
                                        (MAX_ACCELERATION_Y * 2), \
                                        (MAX_ACCELERATION_Z * 2), \
                                        (MAX_ACCELERATION_E * 2) } // ...or, set your own edit limits
#endif
...
#define DEFAULT_RETRACT_ACCELERATION    DEFAULT_ACCELERATION  // E acceleration for retracts
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING          // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 20, 0.6f, 15 } // ...or, set your own edit limits
  #endif
#endif
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013f // (mm) Distance from real junction edge
 ...
 */
#ifdef USE_BLTOUCH
  #define Z_MIN_PROBE_PIN Z_HOME_DIR
#endif
...
//#define PREHEAT_BEFORE_PROBING
  ...
  #define PROBING_NOZZLE_TEMP PREHEAT_1_TEMP_HOTEND   // (°C) Only applies to E0 at this time
  #define PROBING_BED_TEMP    PREHEAT_1_TEMP_BED
#endif
...
// #define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP  PREHEAT_1_TEMP_HOTEND   // (°C) Only applies to E0 at this time
  #define LEVELING_BED_TEMP        PREHEAT_1_TEMP_BED
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_NOZZLE_SIZE    0.4f  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.2f  // (mm) Default layer height for G26.
    #define MESH_TEST_HOTEND_TEMP     205  // (°C) Default nozzle temperature for G26.
    #define MESH_TEST_BED_TEMP         60  // (°C) Default bed temperature for G26.
    #define G26_XY_FEEDRATE            20  // (mm/s) Feedrate for G26 XY moves.
    #define G26_XY_FEEDRATE_TRAVEL    100  // (mm/s) Feedrate for G26 XY travel moves.
    #define G26_RETRACT_MULTIPLIER   1.0f  // G26 Q (retraction) used by default between mesh test elements.
  #endif
 ...
 */
  ...
  #define LCD_BED_LEVELING
    ...
    #define MESH_EDIT_Z_STEP  0.025f  // (mm) Step size while manually probing Z axis.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_HEIGHT      0.0f        // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP       4.0f        // (mm) Z height of nozzle between tramming points
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT  { (X_BED_SIZE - 5), \
                               (Y_BED_SIZE - 10), \
                               5 }
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  (X_BED_SIZE - 5), (Y_BED_SIZE - 10), (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { (X_BED_SIZE - 5), (Y_BED_SIZE / 2), (Z_MIN_POS + 1) } }
  ...
  #define NOZZLE_CLEAN_MIN_TEMP PREHEAT_1_TEMP_HOTEND
