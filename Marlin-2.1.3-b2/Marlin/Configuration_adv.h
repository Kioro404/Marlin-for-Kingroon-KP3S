...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { X_MIN_POS + MESH_INSET, Y_MIN_POS + MESH_INSET }, \
                              { X_MAX_POS - MESH_INSET, Y_MIN_POS + MESH_INSET }, \
                              { X_MAX_POS - MESH_INSET, Y_MAX_POS - MESH_INSET }, \
                              { X_MIN_POS + MESH_INSET, Y_MAX_POS - MESH_INSET } }
...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X          40.0f   // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X          0.15f   // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y          40.0f   // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y          0.15f   // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Z)
    #define SHAPING_FREQ_Z          40.0f   // (Hz) The default dominant resonant frequency on the Z axis.
...
#define DEFAULT_MINIMUMFEEDRATE       0.0f     // (mm/s) Minimum feedrate. Set with M205 S.
#define DEFAULT_MINTRAVELFEEDRATE     0.0f     // (mm/s) Minimum travel feedrate. Set with M205 T.
...
//#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_CORRECTION    0.0f       // 0.0 = no correction; 1.0 = full correction
  ...
  //#define BACKLASH_GCODE
    ...
    #define MEASURE_BACKLASH_WHEN_PROBING
      ...
      #define BACKLASH_MEASUREMENT_LIMIT         0.5f  // (mm)
      #define BACKLASH_MEASUREMENT_RESOLUTION  0.005f  // (mm)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #ifdef ONE_CLICK_PRINT
    #define NO_SD_AUTOSTART                 // Remove auto#.g file support completely to save some Flash, SRAM
  #else
    #define MENU_ADDAUTOSTART               // Add a menu option to run auto#.g files
    
    // #ifdef MENU_ADDAUTOSTART
    //   #define SD_AUTOSTART_FILE "auto.gcode"    // Name of the auto-start file
    // #endif
  ...
  #define EVENT_GCODE_SD_ABORT "G27 P2\n\
                                ...
                                G4 S75\n\
                                G27\n\
                                G1 Y190 F500"        // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define PLR_BED_THRESHOLD   (BED_MAXTEMP / 2)   // (°C) Skip user confirmation at or above this bed temperature (0 to disable)
    ...
    #define POWER_LOSS_MIN_Z_CHANGE         0.05f   // (mm) Minimum Z change before saving power-loss data
    ...
    //#define POWER_LOSS_RECOVER_ZHOME
      ...
      #define POWER_LOSS_ZHOME_POS { X_MAX_POS, Y_MAX_POS } // Safe XY position to home Z while avoiding objects on the bed
    #endif
  #endif
...
//
  ...
  #define DGUS_UPDATE_INTERVAL_MS  250    // (ms) Interval between automatic screen updates
 ...
 */
// #define LIN_ADVANCE	// Linear Advance
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.22f }   // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.22f       // (mm) Compression length applying to all extruders
  #endif
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MIN_ARC_SEGMENT_MM     0.1f // (mm) Minimum length of each arc segment
  #define MAX_ARC_SEGMENT_MM     1.0f // (mm) Maximum length of each arc segment
...
//#define FWRETRACT
  ...
  #define FWRETRACT_AUTORETRACT             // Override slicer retractions
    ...
    #define MIN_AUTORETRACT             0.1f  // (mm) Don't convert E moves under this length
    #define MAX_AUTORETRACT            10.0f  // (mm) Don't convert E moves over this length
  #endif
...
//#define NO_VOLUMETRICS
  ...
  //#define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT  0.00f   // (mm^3/sec)
...
#define CANCEL_OBJECTS
  ...
  #define CANCEL_OBJECTS_ZRAISE POWER_LOSS_ZRAISE  // (mm) Z raise for canceled objects
  // #define CANCEL_OBJECTS_GCODE  ""
#endif
